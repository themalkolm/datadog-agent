...
def get_nikos_linker_flags(nikos_libs_path):
    nikos_libs = [
        'dnf', 'gio-2.0', 'modulemd', 'gobject-2.0', 'ffi', 'yaml', 'gmodule-2.0', 
        'repo', 'glib-2.0', 'pcre', 'z', 'solvext', 'rpm', 'rpmio', 'bz2', 'solv', 'gpgme', 
        'assuan', 'gcrypt', 'gpg-error', 'sqlite3', 'curl', 'nghttp2', 'ssl', 'crypto', 
